    ...
    reply = claude(key, {"model": "claude-sonnet-5", "max_tokens": 3000,
        "messages": [{"role": "user", "content": [
            {"type": "text", "text":
                ...
                f"{lessons}\n"
                "FIRST: name the photo's single most striking visual ANOMALY — "
                "the thing a stranger would mention first (half the face sheeted "
                "in blood; a giant ruffled train; an object where a head should "
                "be). The best pairing usually shares THAT anomaly, not just the "
                "pose or mood. One hypothesis MUST be dedicated to the anomaly: "
                "name artworks with the same anomaly (a face half-covered — by "
                "liquid, shadow, cloth, or an object).\n\n"
                ...
                "- VIGNETTE: dense anthology paintings (Bosch's Garden of Earthly "
                "Delights and Last Judgment, Bruegel's Proverbs, Children's Games, "
                "Triumph of Death, Carnival and Lent) contain HUNDREDS of little "
                "scenes — a drummer, a brawl, a kiss, a pratfall. Ask which "
                "anthology painting would contain this moment as a background "
                "vignette; the match may be 3% of the canvas.\n"
