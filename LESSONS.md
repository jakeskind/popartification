...
- **travis kalanick water-skiing** → *The Life Line* (Winslow Homer, Philadelphia). Four families were rejected (chariots, Phaethon, Neptune, waves) before the right read: the photo's subject is not "a man on water" but **a figure held over churning water by a taut line**. Naming the load-bearing element (the ROPE, not the sport) found it immediately. When rounds keep missing, re-describe the photo as a physics diagram, not a scene.
